...
function squooshImagePoolSetup() {
  if (!pool) {
    ...
    pool = squooshImagePoolCreate(Math.max(cpus.length - 1, 1)); // workarounds for https://github.com/GoogleChromeLabs/squoosh/issues/1152
    // @ts-ignore
...
function sharpGenerate(original, minimizerOptions) {
  var _minimizerOptions$enc2;

  const targetFormats =
  /** @type {SharpFormat[]} */
  Object.keys((_minimizerOptions$enc2 = minimizerOptions.encodeOptions) !== null && _minimizerOptions$enc2 !== void 0 ? _minimizerOptions$enc2 : {});
